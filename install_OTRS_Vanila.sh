...
echo -e "\\n${yellow}======================================================================="
# copy the InstallTestsystem_Vanila.pl script in otrs/Custom folder, execute it, and delete it
cp /opt/scripts/InstallTestsystem_Vanila.pl /opt/otrs/Custom/
sudo perl Custom/InstallTestsystem_Vanila.pl -p /opt/otrs -f /opt/Fred/
rm /opt/otrs/Custom/InstallTestsystem_Vanila.pl
echo -e "\\n${yellow}======================================================================="
